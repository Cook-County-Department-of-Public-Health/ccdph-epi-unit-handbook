...
Onboarding new employees is the process of integrating them into CCDPH's Epidemiology Unit and setting them up for success in their new roles. effective onboarding is important for ensuring that new Epidemiology Unit employees are able to quickly become productive and engaged members of the team. The Epidemiology Unit has different types of employees that vary in terms of (inter-institutional) responsibilities, information technology permissions, pay structure, contract scope, management, and employment period. The onboarding process differs in some ways for these roles. This chapter summarizes and outlines the key steps in the onboarding process for each position type:
