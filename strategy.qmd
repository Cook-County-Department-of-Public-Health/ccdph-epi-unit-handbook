...
![Epidemiology Unit Vision, Mission, and Core Functions](mission_vision_core_fxs_ccdph_epi_unit.PNG){#fig-epi-vision-mission-fxs fig-alt="CCDPH Epidemiology Unit Vision, Mission, and Core Functions."}
